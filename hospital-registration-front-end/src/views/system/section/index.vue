<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="科室编码" prop="sectionCode">
        <el-input
    ...
    <el-table v-loading="loading" :data="sectionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="科室ID" align="center" prop="sectionId" />
      <el-table-column label="科室名称" align="center" prop="sectionName" />
      <el-table-column label="科室编码" align="center" prop="sectionCode" />
      <el-table-column label="科室描述" align="center" prop="sectionDesc" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="科室编码" prop="sectionCode">
          <el-input v-model="form.sectionCode" placeholder="请输入科室编码" />
        </el-form-item>
        <el-form-item label="科室描述" prop="sectionDesc">
          <el-input v-model="form.sectionDesc" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
...
<script>
import { listSection, getSection, delSection, addSection, updateSection } from "@/api/system/section";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除科室编号为"' + sectionIds + '"的数据项？').then(function() {
