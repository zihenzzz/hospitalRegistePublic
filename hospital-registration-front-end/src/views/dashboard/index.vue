    ...
    <el-row :gutter="20" class="main-content">
      ...
      <el-col :xs="24" :lg="16">
        <div class="card-box">
          ...
          <el-table :data="appointments" style="width: 100%" :show-header="true" size="medium">
...
export default {
  ...
  data() {
    return {
      ...
      completedTasks: 86,
      stats: {
        totalPatients: '12,580',
        todayAppointments: '256',
        waitingCount: '32',
        completedToday: '198'
      },
      appointments: [
  ...
  methods: {
    getStatusType(status) {
      const types = { '已就诊': 'success', '等待中': 'warning', '未到': 'info', '取消': 'danger' }
      return types[status] || 'info'
    },
    handleAction(type) {
      this.$message.info(`点击了${type}操作`)
    },
    viewAllAppointments() {
...
.notice-list {
  .notice-item {
    ...
    .notice-content { flex: 1;
      h4 { font-size: 14px; font-weight: 500; color: #1E293B; margin: 0 0 4px 0; }
...
@media screen and (max-width: 768px) {
  ...
  .welcome-section { padding: 24px;
    ...
    .welcome-stats { gap: 24px; .stat-item .stat-value { font-size: 24px; } }
  }
